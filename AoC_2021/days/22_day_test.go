...
func day22_SmallExampleData() string {
...
func day22_LargeExampleData() string {
...
func day22_Part2ExampleData() string {
...
func TestDay22_Part1(t *testing.T) {
	tests := []struct {
		...
		{"small example data", day22_SmallExampleData(), 39},
		{"large example data", day22_LargeExampleData(), 590784},
	}
...
func TestDay22_Part2(t *testing.T) {
	tests := []struct {
		...
		{"small example data", day22_SmallExampleData(), 39},
		{"example data", day22_Part2ExampleData(), 2758514936282235},
	}
